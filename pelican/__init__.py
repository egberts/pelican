...
you to create web sites by composing text files in formats such as 
Markdown, reStructuredText, and HTML.

With Pelican, you can create web sites without worrying about 
...
class Pelican:
    """
    Class for the entire Pelican project
    """
    ...
    def init_path(self):
        """ Add this path to the Python module search path, if missing.
